...
namespace Service.Controllers
{
    ...
    public ActionResult Get(int id)
    {
        ...
        if (result != null)
            ...
            return Json(Result.Err("activID不存在"));
    }
    [HttpPost]
    ...
    public ActionResult PutVerify([FromBody] Model.Activity activity)
    {
        try
        {
            int n = DAL.Activity.Instance.UpdateVerify(activity);
            if (n != 0)
    ...
    public ActionResult PutRecommend([FromBody] Model.Activity activity)
    {
        ...
        try
        {
            ...
            int n = DAL.Activity.Instance.UpdateRecommend(activity);
            if (n != 0)
    ...
    public ActionResult upImg(int id,List<IFormFile> files)
    {
        ...
        try
        {
            int ext = DAL.Upload.Instance.UpImg(files[0], fileName);
            if (ext == null)
